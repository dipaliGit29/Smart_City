...
function VeterinaryHospitalList() {
  ...
  useEffect(() => {
    const fetchHospitals = async () => {
      try {
        ...
        const response = await fetch("/src/json/veterinaryHospitals.json");
  ...
  return (
    <>
      ...
      <h2 className="text-white  text-center py-16 text-2xl font-extrabold">Veterinary Hospitals</h2>
...
export default VeterinaryHospitalList;
