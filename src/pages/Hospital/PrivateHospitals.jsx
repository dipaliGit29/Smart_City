...
function PrivateHospitals() {
  const [hospitals, setHospitals] = useState([]);

  useEffect(() => {
    const fetchHospitals = async () => {
      try {
        const response = await fetch("/src/json/privateHospitals.json");
  ...
  return (
    <>
      ...
      <h2 className="text-white  text-center py-16 text-2xl font-extrabold">Private Hospitals</h2>
