...
function NonVegRestaurants() {
  const [restaurants, setRestaurants] = useState([]);

  useEffect(() => {
    const fetchRestaurants = async () => {
      try {
        const response = await fetch("/src/json/nonVegRestro.json");
  ...
  return (
    <>
      ...
      <h2 className="text-white  text-center py-16 text-2xl font-extrabold">Non-Veg Restaurants</h2>
...
export default NonVegRestaurants;
